    ...
    <div class="min-w-full inline-block align-middle">
      <div data-hs-datatable='{
        ...
        <div class="py-3 flex justify-between items-center">
          ...
          <a href="{{ route('positions.create') }}" class="py-2 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
            Nuevo Cargo
          </a>
        </div>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
              @foreach($positions as $position)
                <tr>
                  <td class="py-3 ps-3">
                    <div class="flex items-center h-5">
                      <input id="hs-table-search-checkbox-{{ $position->id }}" type="checkbox" class="border-gray-300 rounded text-blue-600 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-600 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" data-hs-datatable-row-selecting-individual="">
                      <label for="hs-table-search-checkbox-{{ $position->id }}" class="sr-only">Checkbox</label>
                    </div>
                  </td>
                  ...
                  <td class="p-3 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
                    <span class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium {{ $position->active ? 'bg-teal-100 text-teal-800' : 'bg-red-100 text-red-800' }}">
                  ...
                  <td class="p-3 whitespace-nowrap text-end text-sm font-medium">
                    <a href="{{ route('positions.edit', $position) }}" class="text-blue-500 hover:text-blue-700 mr-4">
                      Editar
                    </a>

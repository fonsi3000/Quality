<nav class="space-y-2">
    ...
    <div class="space-y-2">
        ...
        <a href="#" 
            class="flex items-center gap-x-3.5 py-2.5 px-3 text-sm font-medium {{ Request::routeIs('documents.in-approval') ? 'text-gray-700 bg-gray-100 dark:bg-neutral-700 dark:text-white' : 'text-gray-600 hover:bg-gray-100 dark:hover:bg-neutral-700 dark:text-neutral-300' }} rounded-lg">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <!-- Menu completo para admin y agentes -->
    <div class="hs-accordion" id="documents-accordion">
        ...
        <div id="documents-submenu" class="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300 ps-3">
            ...
            <div class="hs-accordion" id="doc-management-accordion">
                ...
                <div id="doc-management-submenu" class="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300 ps-3">
                    @canany(['admin.only', 'admin.agent'])
                    <a href="{{ route('documents.requests.index') }}" 
                        class="flex items-center gap-x-3.5 py-2.5 px-3 text-sm font-medium {{ Request::routeIs('documents.requests.*') ? 'text-gray-700 bg-gray-100 dark:bg-neutral-700 dark:text-white' : 'text-gray-600 hover:bg-gray-100 dark:hover:bg-neutral-700 dark:text-neutral-300' }} rounded-lg">
                        Solicitud de Documentos
        ...
        <div class="hs-accordion" id="doc-settings-accordion">
            ...
            <div id="doc-settings-submenu" class="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300 ps-3">

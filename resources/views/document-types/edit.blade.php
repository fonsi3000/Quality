    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-neutral-800">
        <div class="mb-8">
            ...
            <p class="text-sm text-gray-600 dark:text-neutral-400 py-4">
                Modifique la información del tipo de documento.
            </p>
        </div>
            ...
            <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                ...
                <div class="sm:col-span-9">
                    <textarea id="description" name="description" rows="3"
                              ...
                              placeholder="Ingrese una descripción del tipo de documento">{{ old('description', $documentType->description) }}</textarea>
                    @error('description')
                        <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="sm:col-span-9">
                    <div class="space-y-2">
                        <p class="text-sm text-gray-600 dark:text-neutral-400">
                            ...
                            {{ $documentType->created_at->format('d/m/Y H:i') }}
                        </p>
                        <p class="text-sm text-gray-600 dark:text-neutral-400">
